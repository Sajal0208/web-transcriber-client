  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden bg-gradient-to-b from-gray-900 to-black"
      >
        <input
          ref={fileInputRef}
              ...
              >
                <div className="flex justify-between w-full items-center gap-4">
                  ...
                  <motion.p
                    ...
                    animate={{ opacity: 1 }}
                    layout
                    className="rounded-lg px-2 py-1 w-fit flex-shrink-0 text-sm text-gray-300 bg-gray-700 shadow-input"
                  >
...
export function GridPattern() {
  ...
  const rows = 11;
  return (
    <div className="flex bg-gray-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px scale-105">
